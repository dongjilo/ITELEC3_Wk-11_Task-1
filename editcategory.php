...
<div class="container w-50 mt-5">
    <div class="card p-4">
        ...
        <form action="operation/update.php?table=categorytbl" method="post">
            ...
            <div class="form-floating mb-3">
                <input type="text" class="form-control" id="floatingName" placeholder="Name" name="txtcatname" value="<?php echo $name; ?>">
                <label for="floatingName">Enter Category Name</label>
            </div>

            <div class="form-floating mb-3">
                <input type="text" class="form-control" id="floatingUname" placeholder="Username" name="txtcatdes" value="<?php echo $desc; ?>">
                <label for="floatingUname">Enter Category Description</label>
            </div>
            ...
            <?php
                if (isset($_SESSION["sess_upd_err_cat"])) {
                    $error = $_SESSION["sess_upd_err_cat"];
                    echo "
                ...
                if (isset($_SESSION["sess_upd_suc_cat"])) {
                    $success = $_SESSION["sess_upd_suc_cat"];
                    echo "
