        ...
        <?php
            ...
            if ($query->num_rows > 0) {
                ...
                while($row = $query -> fetch_assoc()){
                    ...
                    echo "<td>$username</td>";
                    echo "<td>$password</td>";
                    echo "<td class='text-center'><a href='operation/delete.php?id=$id&table=$tbl' class='btn btn-danger btn-sm' onclick='return confirm(`Are you sure you want to delete this row?`)'>
