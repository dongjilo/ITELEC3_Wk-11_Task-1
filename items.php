    ...
    <div class="card p-4">
        ...
        if ($query->num_rows > 0) {
            ...
            while($row = $query -> fetch_assoc()){
                ...
                echo "<td class='text-center'><a href='operation/delete.php?id=$id&tbl=$tbl&loc=$loc' class='btn btn-danger btn-sm' onclick='return return confirm(`Are you sure you want to delete this row?`)'>
